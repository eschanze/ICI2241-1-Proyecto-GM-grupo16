...
public class PatronCircular implements PatronAtaque {
    ...
    public PatronCircular(float x, float y, int numBalas, float velocidad, float duracion, float interDisparo, float velRotation, Texture tex) {
        this.origenX = x;
        this.origenY = y;
    ...
    private void dispararCirculo(Array<Proyectil> proyectiles) {
        ...
        for (int i = 0; i < numBalas; i++) {
            ...
            proyectiles.add(new Proyectil(origenX, origenY, vx, vy, 1, texturaBala));
        }
    }
